...
const Item = ({id,nombre,img, precio,categoria}) => {
    return (
        <article className="rounded-lg  box-border text-center  transition duration-1000 hover:scale-500 hover:shadow-2xl hover:shadow-slate-900 m-5 border-solid border-[1px] border-green w-[215px]">
